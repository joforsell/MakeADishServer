...
final class Dish: Model, Content {
    ...
    init(id: UUID? = nil, title: String, description: String, videoUrlString: String, ingredients: [String], tags: [String], ratings: [Int]) {
        self.id = id
        self.title = title
...
extension FieldKey {
    ...
    static let videoUrlString: FieldKey = "video_url_string"
